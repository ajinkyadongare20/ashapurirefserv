        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                ...
                <div class="col-lg-6 align-self-start text-start text-lg-start my-0 my-lg-5">
                    <p class="text-white my-4">Empowering cold chain excellence with Ashapuri Refrigeration! Delivering innovative refrigeration and seamless logistics solutions to keep your products fresh, secure, and perfectly preserved from origin to destination.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain1.jpg" class="product-card rounded-0" alt="Project Number 1">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain2.jpg" class="product-card rounded-0" alt="Project Number 2">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain3.jpg" class="product-card rounded-0" alt="Project Number 3">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain4.jpg" class="product-card rounded-0" alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain5.jpg" class="product-card rounded-0" alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain6.jpg" class="product-card rounded-0" alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain7.jpg" class="product-card rounded-0" alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/cold_chain8.jpg" class="product-card rounded-0" alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/cold_chain_logistics23.jpg" class="product-card rounded-0"
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/6..jpeg" class="product-card rounded-0"
                            alt="Project Number 4">
                        <div class="card-body">
