    ...
    <div class="py-5">
        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-12 col-lg-6">
                ...
                <img src="<?php bloginfo('template_directory'); ?>/img/Awards/awards1.jpeg" alt="Award 2022"
                    class="img-fluid" style="object-fit: cover; width: 100%; height: 450px;">
            </div>
            ...
            <div class="col-12 col-lg-6">
                ...
                <img src="<?php bloginfo('template_directory'); ?>/img/Awards/awards2.jpeg" alt="Award 2019"
                    class="img-fluid" style="object-fit: cover; width: 100%; height: 450px;">
            </div>
            ...
            <div class="col-12 col-lg-6">
                <img src="<?php bloginfo('template_directory'); ?>/img/Awards/awards3.jpg" alt="Award 2019"
                    class="img-fluid" style="object-fit: cover; width: 100%; height: 450px;">
            </div>
            <div class="col-12 col-lg-6">
                <img src="<?php bloginfo('template_directory'); ?>/img/Awards/awards4.jpg" alt="Award 2019"
                    class="img-fluid" style="object-fit: cover; width: 100%; height: 450px;">
            </div>
        </div>
    </div>
