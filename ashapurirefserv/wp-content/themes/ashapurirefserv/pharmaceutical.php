            ...
            <div class="row">
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/product_23_1.jpg" class="product-card rounded-0"
                ...
                <div class="col-md-6 mb-4 py-3">
                    <div class="card team-card h-100 mx-2 rounded-0">
                        <img src="<?php bloginfo('template_directory'); ?>/img/project/Pharma2.jpg" class="product-card rounded-0" alt="Project Number 2">
                        <div class="card-body">
