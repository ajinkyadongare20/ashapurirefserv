    ...
    <div class="container py-5" id="about-history-who"
        ...
        <div class="row">
            <div class="col-lg-6 text-center mb-4">
                <img src="<?php bloginfo('template_directory'); ?>/img/teams/asfrev_team.jpg" class="img-fluid rounded "
                    alt="Company Team" style="height: 230px; object-fit: cover;">
            </div>
            <div class="col-lg-6">
        ...
        <div class="row mt-4">
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/refrigerator.png"
                        alt="Extensive Experience" class="card-vision-icon">
                    <span class="feature-text">Expertise in Advanced Refrigeration</span>
                </div>
            </div>
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/solution.png"
                        alt="Personalized Approach" class="card-vision-icon">
                    <span class="feature-text">Innovative, Tailored Solutions</span>
                </div>
            </div>
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/predictive.png"
                        alt="Cutting-edge Technology" class="card-vision-icon">
                    <span class="feature-text">High-Quality, Reliable Equipment</span>
                </div>
            </div>
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/customer-support.png"
                        alt="Global Footprint" class="card-vision-icon">
                    <span class="feature-text">Comprehensive Service Offering</span>
                </div>
            </div>
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/energy-control.png"
                        alt="Comprehensive Project Management" class="card-vision-icon">
            ...
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/custom_solution.png"
                        alt="Efficient Supply Chain Management" class="card-vision-icon">
                    <span class="feature-text">Custom Solutions for Unique Needs</span>
                </div>
            </div>
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/growth.png"
                        alt="Innovative Design Solutions" class="card-vision-icon">
                    <span class="feature-text">Commitment to Superior Performance</span>
                </div>
            </div>
            <div class="col-md-4 my-2">
                <div class="about-feature">
                    <img src="<?php bloginfo('template_directory'); ?>/img/about_images/target-audience.png"
                        alt="Advanced Automation Integration" class="card-vision-icon">
