            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center services-card-select selected">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/turnkey.png" alt="Service Icon" class="mb-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/industrial chilers.jpg" alt="Service Icon" class="mb-3">
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/expertise.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Blast Freezer</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/cooling.jpg" alt="Service Icon" class="mb-3">
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/cold-room.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Cold Room Setup</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/planning.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Custom Refrigeration</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/Refrigeration Maintenance.png" alt="Service Icon" class="mb-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/Energy Efficiency Solutions.jpg" alt="Service Icon"
                                class="mb-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/Equipment Manufacturing.jpg" alt="Service Icon" class="mb-3">
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/approach.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">System Commissioning</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/temperature control.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Temperature Control</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/Preventive Maintenance.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Preventive Maintenance</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/refr_upgrade.png" alt="Service Icon" class="mb-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/Cold Chain Solution.png" alt="Service Icon" class="mb-3">
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/refrigerant_machine.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Refrigeration System Design</h5>
                        </div>
                    </div>
                </div> -->
                ...
                <!-- <div class="col-6 col-md-4 col-lg-3">
                    <div class="card service-card text-center">
                        <div class="card-body pt-3" style="width: 100%;">
                            <img src="<?php bloginfo('template_directory'); ?>/img/services_image/refrigerant_leak.jpg" alt="Service Icon" class="mb-3">
                            <h5 class="card-title services-card-title fw-bold">Refrigeration Leak Prevention</h5>
                        </div>
                    </div>
                </div> -->
        ...
        <div class="container mt-5 pb-5">
            <div class="row align-items-center justify-content-center mt-3">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/11.sahyad.jpeg" alt="Ashapuri Refrigeration Group"
                        class="img-fluid">
                </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="mt-31s">At Ashapuri Refrigeration, we specialize in
                    ...
                    <p class=2s"><b>Our facility is equipped with state-of-the-art
