            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4 py-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/1..jpeg" class="card-img-top rounded-0"
                ...
                <div class="col-md-4 mb-4 py-3 wow fadeIn" data-wow-delay="0.9s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/11.sahyad.jpeg" class="card-img-top rounded-0"
                ...
                <div class="col-md-4 mb-4 py-3 wow fadeIn" data-wow-delay="1.1s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/2.HPR LPR RBT.jpeg" class="card-img-top rounded-0"
                ...
                <div class="col-md-4 mb-4 py-3 wow fadeIn" data-wow-delay="1.1s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/ameya_project.jpg" class="card-img-top rounded-0"
                            alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4 py-3 wow fadeIn" data-wow-delay="1.1s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/3.LPR RBT.jpeg" class="card-img-top rounded-0"
                            alt="Project Number 4">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4 py-3 d-none more-cards wow fadeIn" data-wow-delay="1s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/5.Machine room RBT.jpeg" class="card-img-top rounded-0"
                ...
                <div class="col-md-4 mb-4 py-3 d-none more-cards wow fadeIn" data-wow-delay="1.2s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/6..jpeg" class="card-img-top rounded-0"
                            alt="Project Number 5">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4 py-3 d-none more-cards wow fadeIn" data-wow-delay="1.8s">
                    <div class="card team-card h-100 mx-2">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ASHAPURI PROJECT PHOTOS/Piping (Kuppam).jpg" class="card-img-top rounded-0"
                            alt="Project Number 5">
                        <div class="card-body">
